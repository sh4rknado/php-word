...
class TemplateProcessor
{
     ...
     */
    public function zip() { return $this->zipClass; }
    ...
    public function setImg( $strKey, $img){
        ...
        // I'm work for png files, if you are working with other images types -> Write conditions here
        $imgExt = 'png';
    ...
    /**
     * Find and replace macros in the given XML section.C
     *
     * @param mixed $search
     * @param mixed $replace
     ...
     * @return string
     */
    protected function getHeaderName($index) { return sprintf('word/header%d.xml', $index); }
     ...
     * @return string
     */
    protected function getSettingsPartName() { return 'word/settings.xml'; }
     ...
     * @return bool
     */
    protected function textNeedsSplitting($text) { return preg_match('/[^>]\${|}[^<]/i', $text) == 1; }
}
