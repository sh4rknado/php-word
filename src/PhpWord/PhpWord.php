...
class PhpWord {
     ...
     * @return DocInfo
     */
    public function getDocInfo() { return $this->metadata['DocInfo']; }
     ...
     * @codeCoverageIgnore
     */
    public function getProtection() { return $this->getSettings()->getDocumentProtection(); }
     ...
     * @since 0.12.0
     */
    public function getCompatibility() { return $this->metadata['Compatibility']; }
     ...
     * @since 0.14.0
     */
    public function getSettings() { return $this->metadata['Settings']; }
    ...
    public function getSection($index) {
        if (array_key_exists($index, $this->sections)) return $this->sections[$index];
        return null;
    }
     ...
     */
    public function sortSections($sorter) { usort($this->sections, $sorter); }
     ...
     * @return string
     */
    public function getDefaultFontName() { return Settings::getDefaultFontName(); }
     ...
     */
    public function setDefaultFontName($fontName) { Settings::setDefaultFontName($fontName); }
     ...
     * @return int
     */
    public function getDefaultFontSize() { return Settings::getDefaultFontSize(); }
     ...
     * @param int $fontSize
     */
    public function setDefaultFontSize($fontSize) { Settings::setDefaultFontSize($fontSize); }
     ...
     * @return Paragraph
     */
    public function setDefaultParagraphStyle($styles) { return Style::setDefaultParagraphStyle($styles); }
    ...
    public function loadTemplate($filename) {
        if (file_exists($filename)) return new TemplateProcessor($filename);
     ...
     *
     */
    public function createSection($settings = null) { return $this->addSection($settings); }
     ...
     * @codeCoverageIgnore
     */
    public function getDocumentProperties() { return $this->getDocInfo(); }
