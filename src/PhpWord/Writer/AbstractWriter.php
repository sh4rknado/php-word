...
abstract class AbstractWriter implements WriterInterface {
    ...
    public function getPhpWord() {
        if (!is_null($this->phpWord)) { return $this->phpWord; }
     ...
     */
    protected function clearTempDir() { if (is_dir($this->tempDir)) $this->deleteDir($this->tempDir); }
     ...
     * @codeCoverageIgnore
     */
    public function getUseDiskCaching() { return $this->isUseDiskCaching(); }
}
