...
class HTML extends AbstractWriter implements WriterInterface
{
     ...
     * @return bool
     */
    public function isPdf() { return $this->isPdf; }
     ...
     */
    public function addNote($noteId, $noteMark) { $this->notes[$noteId] = $noteMark; }
     ...
     * @codeCoverageIgnore
     */
    public function writeDocument() { return $this->getContent(); }
}
